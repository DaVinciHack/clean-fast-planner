...
export declare namespace MainFlightObjectFp2 {
    type PropertyKeys = 'destinationGeoPoint' | 'alternateLegIds' | 'destinationSunrise' | 'totalDistanceOutboundAndAlternate' | 'alternateSunrise' | 'flightNumber' | 'alternate' | 'destinationSunset' | 'logId' | 'policyUuid' | 'totalDistanceNoAlternate' | 'createdAt' | 'departureSunrise' | 'totalFlightTime' | 'region' | 'alternateName' | 'avgWindDirection' | 'legsNames' | 'weatherWarnings' | 'timingId' | 'additionalCrew' | 'copilot' | 'legIds' | 'totalMinFlightTimeToAlternate' | 'combinedWaypoints' | 'updatedAt' | 'weightBalanceId' | 'alternateFullRouteGeoShape' | 'createdBy' | 'departureGeoPoint' | 'alternateSplitPoint' | 'avgWindSpeed' | 'departureSunset' | 'aircraftId' | 'alternateSunset' | 'fullRouteGeoShape' | 'flightId' | 'fuelPlanId' | 'captain' | 'totalFlightTimeWithStops' | 'etd' | 'alternateGeoPoint' | 'legs';
    interface Links {

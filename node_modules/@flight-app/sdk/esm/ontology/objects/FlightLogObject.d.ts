...
export declare namespace FlightLogObject {
    type PropertyKeys = 'captainDayTime' | 'comments' | 'captainId' | 'copilotId' | 'shutdownFuel' | 'legDayMinutes' | 'flightNumber' | 'waypointActualTimes' | 'startupTime' | 'totalPaxWeight' | 'approachType' | 'logId' | 'onBlocksTime' | 'copilotDayTime' | 'legFuelUplifted' | 'onBlocksFuel' | 'totalBagsPaxWeight' | 'legLandingTimes' | 'paxNumber' | 'waypointActualFuel' | 'captainNightTime' | 'bagsWeight' | 'offBlocksTime' | 'deviceId' | 'legPlannedTakeoffTimes' | 'copilotTotalTime' | 'copilotNightTime' | 'aircraftId' | 'legPlannedLandingTimes' | 'flightId' | 'legNightMinutes' | 'waypointNames' | 'captainTotalTime' | 'legTakeoffFuel' | 'landingOn' | 'isUploaded' | 'captainLandings' | 'incidentId' | 'copilotLandings' | 'maintenanceNotes' | 'totalTime' | 'delayReasons' | 'totalFlightTime' | 'totalFuelBurned' | 'legPilotFlying' | 'lastSyncTime' | 'legPlannedTakeoffFuel' | 'legTakeoffTimes' | 'hasPendingChanges' | 'legLandingFuel' | 'legIds' | 'waypointPlannedTimes' | 'additionalCrewIds' | 'legNames' | 'logDate' | 'averagePaxWeight' | 'offBlocksFuel' | 'legLandings' | 'waypointPlannedFuel' | 'startupFuel' | 'legPlannedLandingFuel' | 'initialFuelUplifted';
    type Links = {};
    interface Props {

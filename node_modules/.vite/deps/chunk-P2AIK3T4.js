...
var _DisposableStack = class _DisposableStack {
   ...
   */
  [(_b = disposeSymbol, _a = Symbol.toStringTag, _b)]() {
    if (__privateGet(this, _disposed)) {
      return;
    }
    __privateSet(this, _disposed, true);
...
var _a2, _b2, _disposed2, _stack2;
var _AsyncDisposableStack = class _AsyncDisposableStack {
   ...
   * Disposes each resource in the stack in last-in-first-out (LIFO) manner.
   */
  async [(_b2 = asyncDisposeSymbol, _a2 = Symbol.toStringTag, _b2)]() {
    if (__privateGet(this, _disposed2)) {
      return;
    }
    __privateSet(this, _disposed2, true);
...
async function importDebug() {
  if (!debugModule) {
    debugModule = (await import("./browser-DOVKG56F.js")).default;
  }
  return debugModule;
}
var debug = (prefix) => {
    ...
    errorContext(function() {
      ...
      if (!_this.isStopped) {
        ...
        try {
          ...
          try {
            if (_c && !_c.done && (_a4 = _b3.return)) _a4.call(_b3);
          } finally {
            if (e_1) throw e_1.error;
          }
        }
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_b3) {
      switch (_b3.label) {
        ...
        case 2:
          if (!(asyncIterable_1_1 = _b3.sent(), !asyncIterable_1_1.done)) return [3, 4];
    ...
    source2.subscribe(createOperatorSubscriber(subscriber, function(value) {
      ...
      if (toEmit) {
        try {
          ...
          try {
            if (toEmit_1_1 && !toEmit_1_1.done && (_b3 = toEmit_1.return)) _b3.call(toEmit_1);
          } finally {
            if (e_2) throw e_2.error;
          }
        }
...
var _isResolved, _isRejected, _value, _resolve, _taskPromise, _timeoutId, _timeoutError, _Deferred_instances, finish_fn, _promise;
...
_Deferred_instances = new WeakSet();
...
var _updated, _amendments, _ScriptInjector_instances, update_fn, get_fn;
...
var ElementHandle = (() => {
  var _ElementHandle_instances, $$_get, $$impl_fn, checkVisibility_fn, clickableBox_fn, intersectBoundingBoxesWithFrame_fn, getTopLeftCornerOfFrame_fn, nonEmptyVisibleBoundingBox_fn, asSVGElementHandle_fn, getOwnerSVGElement_fn, _a4;
  ...
  return _a4 = class extends _classSuper {
    ...
    async isIntersectingViewport(options = {}) {
      ...
      try {
        ...
        const target = __addDisposableResource5(env_5, handle && await __privateMethod(_a5 = handle, _ElementHandle_instances, getOwnerSVGElement_fn).call(_a5), false);
    ...
    while (parentFrame = frame == null ? void 0 : frame.parentFrame()) {
      ...
      try {
        ...
        await __privateMethod(_a5 = handle, _ElementHandle_instances, intersectBoundingBoxesWithFrame_fn).call(_a5, boxes);
        frame = parentFrame;
      } catch (e_3) {
        env_3.error = e_3;
        env_3.hasError = true;
...
var _ensureElementIsInTheViewport, _waitForEnabled, _waitForStableBoundingBox, _waitForEnabledIfNeeded, _waitForStableBoundingBoxIfNeeded, _ensureElementIsInTheViewportIfNeeded, _Locator_instances, click_fn, fill_fn, hover_fn, scroll_fn;
...
var Frame = (() => {
  var __document, _Frame_instances, document_fn, _a4;
...
var _HTTPRequest_instances, canBeIntercepted_fn;
...
var Page = (() => {
  var _requestHandlers, _inflight$, _screencastSessionCount, _startScreencastPromise, _Page_instances, getNativePixelDimensions_fn, _a4;
  let _classSuper = EventEmitter;
  let _instanceExtraInitializers = [];
  let _screenshot_decorators;
  return _a4 = class extends _classSuper {
...
var _world, _polling, _root, _fn, _args, _timeout, _timeoutError2, _result, _poller, _signal, _reruns, _onAbortSignal;
var WaitTask = class {
...
var _richlyEditable, _editable, _focusable, _hidden, _name, _role, _ignored, _cachedHasFocusableChild, _realm2, _AXNode_instances, isPlainTextField_fn, isTextOnlyObject_fn, hasFocusableChild_fn;
...
hasFocusableChild_fn = function() {
  ...
  if (__privateGet(this, _cachedHasFocusableChild) === void 0) {
    ...
    for (const child of this.children) {
      if (__privateGet(child, _focusable) || __privateMethod(_a4 = child, _AXNode_instances, hasFocusableChild_fn).call(_a4)) {
...
var _client, _enabled, _scriptURLs, _scriptSources, _subscriptions, _resetOnNavigation, _reportAnonymousScripts, _includeRawScriptCoverage, _JSCoverage_instances, onExecutionContextsCleared_fn, onScriptParsed_fn;
...
var _client2, _enabled2, _stylesheetURLs, _stylesheetSources, _eventListeners, _resetOnNavigation2, _CSSCoverage_instances, onExecutionContextsCleared_fn2, onStyleSheet_fn;
...
var EmulationManager = (() => {
  var _client4, _emulatingMobile, _hasTouch, _states, _viewportState, _idleOverridesState, _timezoneState, _visionDeficiencyState, _cpuThrottlingState, _mediaFeaturesState, _mediaTypeState, _geoLocationState, _defaultBackgroundColorState, _javascriptEnabledState, _secondaryClients, _EmulationManager_instances, applyViewport_get, emulateIdleState_get, emulateTimezone_get, emulateVisionDeficiency_get, emulateCpuThrottling_get, emulateMediaFeatures_get, emulateMediaType_get, setGeolocation_get, setDefaultBackgroundColor_get, setJavaScriptEnabled_get, _a4;
  let _instanceExtraInitializers = [];
  ...
  }, _client4 = new WeakMap(), _emulatingMobile = new WeakMap(), _hasTouch = new WeakMap(), _states = new WeakMap(), _viewportState = new WeakMap(), _idleOverridesState = new WeakMap(), _timezoneState = new WeakMap(), _visionDeficiencyState = new WeakMap(), _cpuThrottlingState = new WeakMap(), _mediaFeaturesState = new WeakMap(), _mediaTypeState = new WeakMap(), _geoLocationState = new WeakMap(), _defaultBackgroundColorState = new WeakMap(), _javascriptEnabledState = new WeakMap(), _secondaryClients = new WeakMap(), _EmulationManager_instances = new WeakSet(), applyViewport_get = function() {
...
puppeteer-core/lib/esm/puppeteer/common/TimeoutSettings.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-P2AIK3T4.js.map

class WeatherSegmentsLayer {
  ...
  addMainSegments() {
    ...
    const features = this.currentSegments.filter((segment) => segment.geoPoint).map((segment) => this.createSegmentFeature(segment, "main"));
...
export {
  WeatherSegmentsLayer as default
};
//# sourceMappingURL=WeatherSegmentsLayer-NF_X3nps.js.map

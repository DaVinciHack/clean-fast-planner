// --- COPY AND PASTE THESE FUNCTIONS INTO ModularFastPlannerComponent.jsx ---
...
// Add this to the calculateRouteStats function at the beginning:
/*
  // Ensure flight calculator has the latest settings
  syncFlightCalculator();
*/
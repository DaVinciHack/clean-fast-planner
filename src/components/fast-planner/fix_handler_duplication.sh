...
# Fix the duplicated arrow function syntax
sed -i '' -e 's/const handleReserveFuelChange = (fuel) => { = (fuel) => {/const handleReserveFuelChange = (fuel) => {/g' /Users/duncanburbury/Fast-Planner-Clean/src/components/fast-planner/ModularFastPlannerComponent.jsx.tmp
...
echo "Fixed duplication in handleReserveFuelChange function."
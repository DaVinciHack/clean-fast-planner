<?php
/**
 * Aviation Weather Center Proxy - Mimics Vite /api/awc/ proxy
 * Handles requests like: /api/awc/api/data/metar?ids=KHOU...
 */
...
// Get the path after /api/awc/
$requestUri = $_SERVER['REQUEST_URI'];

// Extract path from URI - everything after /api/awc/
$pattern = '/\/api\/awc\/(.+?)(?:\?|$)/';
...
error_log("AWC Proxy: $requestUri -> $targetUrl");

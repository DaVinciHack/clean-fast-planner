<?php
/**
 * NOAA Buoy Data Proxy - Mimics Vite /api/buoy/ proxy
 * Handles requests like: /api/buoy/data/realtime2/42001.txt
 */
...
// Get the path after /api/buoy/
$requestUri = $_SERVER['REQUEST_URI'];

// Extract path from URI - everything after /api/buoy/
$pattern = '/\/api\/buoy\/(.+?)(?:\?|$)/';
...
error_log("Buoy Proxy: $requestUri -> $targetUrl");

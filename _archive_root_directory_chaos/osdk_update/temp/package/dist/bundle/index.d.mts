...
declare module "@flight-app/sdk" {
	...
	export { AirportsData, AllGtLocationsV2, Asset, BristowHelidecks, FlightFuelDburbury, FlightLogObject, FuelPolicyBuilder, InternationalWeather, LegObjectOutputObject, MainFlightObjectFp2, MainFuelV2, NorwayWeatherSegments, NorwayWeatherXv8, RegionalWeatherMinimaSettings, User, } from '@flight-app/sdk/ontology/objects';
...
declare module "@flight-app/sdk/ontology/actions/updateAlternantOneStep" {
	...
	export namespace updateAlternantOneStep {
	    ...
	    interface Signatures {
	         ...
	         * Updates the alternate and re calculates fuel and timing
	         */
	        applyAction<P extends updateAlternantOneStep.Params, OP extends ApplyActionOptions>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
	        batchApplyAction<P extends ReadonlyArray<updateAlternantOneStep.Params>, OP extends ApplyBatchActionOptions>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
	    }
	}
	/**
	 * Updates the alternate and re calculates fuel and timing
...
declare module "@flight-app/sdk/ontology/actions/updateFastPlannerFlight" {
	...
	export namespace updateFastPlannerFlight {
	    ...
	    interface Signatures {
	         ...
	         * updateFastPlannerFlight
	         */
	        applyAction<P extends updateFastPlannerFlight.Params, OP extends ApplyActionOptions>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
	        batchApplyAction<P extends ReadonlyArray<updateFastPlannerFlight.Params>, OP extends ApplyBatchActionOptions>(args: P, options?: OP): Promise<ActionReturnTypeForOptions<OP>>;
	    }
	}
	/**
	 * updateFastPlannerFlight
